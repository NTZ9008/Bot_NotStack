...
├── weather/                ← รายงานสภาพอากาศประจำวัน (OpenWeatherMap / กราฟ / เรดาร์ / embed / ตั้งเวลา / API)  
├── db.js  
├── index.js  
├── deploy-command.js  
├── badWords.json  
...
@napi-rs/canvas (วาดการ์ดต้อนรับ กราฟ และแผนที่เรดาร์ — มี binary สำเร็จรูป ไม่ต้องติดตั้งโปรแกรมเพิ่มในเซิร์ฟเวอร์)  
gifenc (ทำ GIF เคลื่อนไหวของแผนที่เรดาร์)  
